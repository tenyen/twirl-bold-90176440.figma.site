...
export const Navbar = () => {
  ...
  return (
    <nav className="backdrop-blur bg-white/60 box-border caret-transparent outline-[oklab(0.839909_-0.141908_-0.0158958_/_0.5)] border-zinc-900/10 border-b border-solid mb-16 md:mb-24 transition-colors">
